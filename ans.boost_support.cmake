        ...
        if(BOOST_SUPPORT_REUSE AND Boost_FOUND)
            ...
            if(Boost_LIBRARIES)
                if (${CMAKE_MAJOR_VERSION}.${CMAKE_MINOR_VERSION} VERSION_LESS 2.8.11)
                    target_include_directories(${BOOST_SUPPORT_TARGET} PUBLIC ${Boost_INCLUDE_DIRS})
                endif()
            ...
            if(OVEN_TO_BOOST_HOME)
                ...
                target_include_directories(${BOOST_SUPPORT_TARGET} PUBLIC ${OVEN_TO_BOOST_HOME})
            endif()
        endif()
    endmacro()
    ...
    macro(boost_header_only_support)
        if(NOT ANS_BOOST_HEADER_ONLY_SUPPORTED)
            ...
            if(OVEN_TO_BOOST_FOUND)
                ...
                target_include_directories(${BOOST_SUPPORT_TARGET} PUBLIC ${OVEN_TO_BOOST_INCLUDE_DIRS})
            endif()
