...
function(install_qt5_executable executable)
  ...
  get_bundle_main_executable(\"${CMAKE_CURRENT_BINARY_DIR}/${executable}\" main)
  message(STATUS \"Main executable of ${executable}: \${main}\")
  execute_process(
      COMMAND otool -l \"\${main}\"
      COMMAND grep -A3 LC_RPATH
      COMMAND grep \"^ *path\"
      COMMAND sed -e \"s/^ *path //\" -e \"s/ .*$//\"
      OUTPUT_VARIABLE rpaths
      OUTPUT_STRIP_TRAILING_WHITESPACE
  )
  message(STATUS \"Rpaths of ${executable}: \${rpaths}\")
  string(REPLACE \"\\n\" \";\" rpaths \"\${rpaths}\")
  set(dirs ${dirs})
  foreach(rpath \${rpaths})
      list(APPEND dirs \${rpath})
  endforeach()
